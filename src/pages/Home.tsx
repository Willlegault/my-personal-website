...
const Home: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      <main className="pt-16"> {/* Add padding to prevent overlap */}
        {/* Hero Section */}
        ...
        {/* Projects Section */}
        <section id="projects" className="py-16 px-6 bg-gray-200">
          <div className="container mx-auto">
            <div className="bg-white p-8 rounded-lg shadow-lg">
        ...
        {/* Skills Section */}
        <section id="skills" className="py-16 px-6 bg-gray-300">
          <div className="container mx-auto">
            <div className="bg-white p-8 rounded-lg shadow-lg">
